        ...
        {achievements.length === 0 ? (
          ...
          achievements.map((achievement, index) => (
            ...
            >
              <div className="flex justify-between items-start gap-3 mb-3">
                <div className="flex-1 min-w-0">
                  ...
                  {achievement.description && (
                    <p className="text-xs sm:text-sm text-gray-400 mb-2">{achievement.description}</p>
                  )}
                </div>
              ...
              {achievement.year && <p className="text-xs sm:text-sm text-gray-500 mt-auto">{achievement.year}</p>}
            </motion.div>
          ))
        )}
      </div>
