...
export default function AboutSection() {
  ...
  return (
    <section id="about" className="min-h-screen flex items-center justify-center py-20 px-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-blue-900 via-purple-900 to-pink-900 dark:from-gray-950 dark:via-blue-950 dark:to-purple-950">
      ...
      <div className="max-w-6xl mx-auto text-center relative z-10">
        ...
        >
            ...
            >
              ...
              <div
                ...
                style={{
                  ...
                  boxShadow: `0 0 30px ${borderColor}40, 0 0 60px ${borderColor}20`,
                }}
              >
                <motion.div 
          ...
          <motion.p
            ...
            className="text-xl md:text-2xl text-gray-200 dark:text-gray-300 max-w-3xl mx-auto mb-8"
          >
          ...
          >
            <CrystalEffect className="bg-white/10 dark:bg-gray-800/50 backdrop-blur-xl rounded-2xl p-8 border border-white/20 dark:border-gray-700/50 shadow-2xl">
              <p className="text-lg text-gray-200 dark:text-gray-300 leading-relaxed relative z-10">
