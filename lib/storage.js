...
const STORAGE_KEYS = {
  ...
  PARTICLE_CONFIG: 'cms_particle_config',
  SOUND_CONFIG: 'cms_sound_config',
  ANALYTICS_CONFIG: 'cms_analytics_config',
};
...
const DATA_KEY_TO_STORAGE_KEY = {
  ...
  particleConfig: STORAGE_KEYS.PARTICLE_CONFIG,
  soundConfig: STORAGE_KEYS.SOUND_CONFIG,
  analyticsConfig: STORAGE_KEYS.ANALYTICS_CONFIG,
};
...
const DB_FIELD_BY_STORAGE_KEY = {
  ...
  [STORAGE_KEYS.PARTICLE_CONFIG]: 'particleConfig',
  [STORAGE_KEYS.SOUND_CONFIG]: 'soundConfig',
  [STORAGE_KEYS.ANALYTICS_CONFIG]: 'analyticsConfig',
};
...
const STORAGE_EVENT_BY_KEY = {
  ...
  [STORAGE_KEYS.PARTICLE_CONFIG]: 'particleConfigUpdated',
  [STORAGE_KEYS.SOUND_CONFIG]: 'soundConfigUpdated',
  [STORAGE_KEYS.ANALYTICS_CONFIG]: 'analyticsConfigUpdated',
};
